...
\begin{enumerate}[nosep]
    ...
    \item Shift in direction of roll (see \changedin{1C}{AWF}{diagram}{Figures~\ref{figure:displacement-roll-maneuvers} and \ref{figure:lag-roll-maneuvers}}) and optionally face 30 degrees in direction opposite to roll.
...
\begin{enumerate}[nosep]
    ...
    \itemaddedin{1B}{JDW in APJ 39 QA}{If done in climbing or diving flight, 1 altitude level may be gained or lost upon executing each roll after the first at no additional FP cost.}
