...
\begin{enumerate}
    ...
    \itemaddedin{1B}{JDW in the APJ 23 errata and APJ 24 play aids}{If missile changed facing by turning, $-1$ to speed for each 30 degrees of facing change done.}
\end{enumerate}
...
\begin{enumerate}
    \item Air to air first turn = $(\textrm{Base} + \textrm{aircraft}) \times \textrm{Speed Att.\ Factor}$. \addedin{1B}{JDW in the APJ 23 errata and APJ 24 play aids}{If the missile has a sustainer, use the factor for the altitude band two above the one in which the missile was launched.}
    \item SAM first turn = listed Base Speed.
    \item Subsequent turns = $(\textrm{Previous} \pm \textrm{changes})  \times \textrm{Speed Att.\ factor}$.
    \item \changedin{1B}{JDW in the APJ 23 errata and APJ 24 play aids}{If sustainer motor in effect}{On subsequent turns, if the sustainer motor is in effect}, Speed Att.\ Factor = 1.0.
\end{enumerate}
