...
\begin{enumerate}[nosep]
    ...
    \itemaddedin{1B}{JDW in the APJ 23 errata}{The protected arcs of aircraft carrying AJMs are: AJM Type A = $180+$, $30-$ arcs, AJM Type B = $150+$, $60-$ arcs, and AJM Type C and D = all arcs.}
\end{enumerate}
}
\end{tabular}
