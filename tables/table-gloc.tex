...
\TABLECAPTION{table:gloc-avoidance}{G-Induced Loss of Consciousness}
...
\TABLECAPTION{table:gloc-recovery}{Recovery from GLOC}
...
\TABLECAPTION{table:gloc-flight}{GLOC/Disoriented Flight}
