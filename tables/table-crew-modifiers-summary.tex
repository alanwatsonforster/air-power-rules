\begin{TABLE*}
\TABLECAPTION{table:crew-modifiers}{Pilot/Crew Ability Modifiers Summary}
\small
...
\begin{itemize}[nosep]
    ...
    \item These modifiers are shown \changedin{1D}{1D-tables}{on the other play aid charts}{in other tables}.
\end{itemize}
\end{tablenote}
