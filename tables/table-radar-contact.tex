...
\begin{enumerate}
    ...
    \item \changedin{1B}{JDW in the TSOH errata and APJ \#24}{CHAFF PPL Effectiveness No.}{Chaff PPL Eff.\ No.\ $-$ $1/2$ radar ECCM (round up).}
    \item Mini-Jammer PPL Effectiveness No.
    \item Aircraft Size Modifier from ADC.
    \itemdeletedin{1B}{JDW in the TSOH errata and APJ \#24}{$+4$ if aircraft has Stealth Technology.}
    \itemaddedin{1B}{JDW in the TSOH errata and APJ \#24}{$-2$ if target aircraft IFF on.}
...
\begin{table}
\centering
\addedin{1B}{JDW in the TSOH errata and APJ \#24}{
