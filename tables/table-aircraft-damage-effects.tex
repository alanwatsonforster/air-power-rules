...
\addlinespace
&The aircraft suffers a $+1$ modifier to air-to-air gun and rocket attacks.\\
\addlinespace
...
\addlinespace
&The aircraft suffers a $+2$ modifier to air-to-air gun and rocket attacks.\\
\addlinespace
...
&The aircraft must check for a system loss.\\
\addlinespace
&The aircraft suffers a $+3$ modifier to air-to-air gun and rocket attacks.\\
\addlinespace
K&The aircraft is destroyed and removed from play. The crew may attempt emergency egress (rule~\ref{rule:emergency-egress}).\\
\addlinespace
\bottomrule
\end{tabularx}
