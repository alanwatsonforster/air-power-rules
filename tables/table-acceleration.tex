...
\begin{itemize}
    ...
    \item \deletedin{2A}{2A:steep-dives}{Steep or }Unloaded dive = +0.5 per level initially, then +1.0 per level.
    \itemaddedin{2A}{2A:steep-dives}{Steep dive = 1.0 AP per level.}
...
\begin{itemize}
    ...
    \itemdeletedin{2A}{2A:sustained}{\changedin{1B}{JDW in the APJ 23 errata}{Sustained turns and rolls 1.0 each, or 2.0 if HBR.}{Sustained turns 1.0 each or 2.0 if HBR.}}
    ...
    \itemaddedin{1B}{JDW in the APJ 23 errata}{Sustained rolls 1.0 each}.
\end{itemize}
\end{minipage}
\end{table}
