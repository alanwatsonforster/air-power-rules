...
\midrule
ALQ-123&IR-Jammer&500&2.0&\multicolumn{2}{l}{\plus{1} in \arc{60} arc, \plus{2} in \arc{30} arc.}&(1971)\\
ALQ-132&IR-Jammer&500&2.0&\multicolumn{2}{l}{\plus{2} in 30, 60 \& \arc{90} arcs.}&(1974)\\
\bottomrule
\end{tabular}
...
\begin{enumerate}[nosep]
    ...
    \itemaddedin{1C}{1C-apj-23-errata/1C-apj-25-qa}{The protected arcs of aircraft carrying AJMs are: AJM Type A = \plusafter{180}, \minusafter{30} arcs, AJM Type B = \plusafter{150}, \minusafter{60} arcs, and AJM Type C and D = all arcs.}
\end{enumerate}
\end{tablenote}
