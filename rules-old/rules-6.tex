...
\begin{itemize}
    ...
    \item An aircraft which turns (even at the EZ rate) while supersonic incurs \changedin{3A}{3A-turns}{1.0 additional decel point for the game turn}{0.5 additional DPs for each turn declared}.
...
\begin{itemize}
    ...
    \item 
    A PSSM aircraft which turns at supersonic speeds (even at the EZ rate) incurs \changedin{3A}{3A-turns}{2.0 additional decel points instead of 1.0}{1.0 DPs for each turn declared instead of 0.5}.
