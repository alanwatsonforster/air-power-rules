...
\begin{itemize}
    ...
    \item \changedin{2B}{2B-damage-control-requirements}{Only non-A/B power sustained climbs allowed.}{The only climbing flight allowed during damage control is a SC without AB.}
    \item \changedin{2B}{2B-damage-control-requirements}{Only non-A/B power steep dives using up to 2 VFPs may be performed.}{The only diving flight allowed during damage control is a SD without AB and at most 2 VFPs}
