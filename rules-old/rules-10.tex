...
\changedin{3X}{3X-aborting-damage-control}{Once an aircraft completes its flight without violating the above restrictions, damage control is automatically completed.}{If the aircraft performs damage control during its entire move, damage control automatically succeeds.
