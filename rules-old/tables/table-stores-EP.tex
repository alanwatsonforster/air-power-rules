...
\begin{enumerate}[nosep]
    ...
    \itemaddedin{1C}{1C-apj-23-errata/1B-apj-25-qa}{The protected arcs of aircraft carrying AJMs are: AJM Type A = \plusafter{180}, \minusafter{30} arcs, AJM Type B = \plusafter{150}, \minusafter{60} arcs, and AJM Type C and D = all arcs.}
\end{enumerate}
\end{tablenote}
