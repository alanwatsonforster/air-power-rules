...
\tablecaption{table:ew-bjm-capabilities}{BJM Stand-Off Jamming}
\begin{tabularx}{\linewidth}{cccP}
\toprule
\multirow{2}{*}[-0.5ex]{\minitable{c}{BJM\\Type}}&
\multicolumn{2}{c}{Allowed Stand-Off Attacks}&
\multirow{2}{*}[-0.5ex]{\minitable{c}{Angle-Off\\Coverage}}\\
\cmidrule{2-3}
&Pilot Only&Multi-Crew&\\
\midrule
A&1&1&\plusafter{180} and \minusafter{30}\\
B&2&2&\plusafter{150} and \minusafter{60}\\
C&2&3&As B, or into any 3 adjacent arcs.\\
D&2&4&As B, or into any \addedin{1C}{1C-apj-23-errata}{four }angle-off arcs.\\
\bottomrule
\end{tabularx}
...
\begin{onecolumntablefloat}
\begin{onecolumntable}
\tablecaption{table:ew-bjm-flexibility}{BJM Programming Flexibility}
