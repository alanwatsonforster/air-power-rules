...
\midrule
Clear&NA&NA&None\\
Forest&NA&NA&All units are considered camouflaged. \plus{2} to Strafe attacks, \plus{1} to all other attacks.\\
River&NA&NA&None\\
...
City&48&5 soft&All units except heavy AAA, SAMs and Radars are consider camouflaged. \plus{2} to all attacks.\\
Town/Village&36&3 soft&Infantry units only are considered camouflaged. \plus{1} to all attacks.\\
\bottomrule
\end{tabularx}
}
\end{twocolumntable}
