...
\midrule
\arc{0} line        &\minus{1}&\minus{1}&\minus{1}&\minus{2}&\plus{0}&\minus{1}&\minus{2}&\minus{1}&\minus{1}&\minus{1}&\plus{0}&\minus{1}\\
...
\arc{180} arcs, line&\plus{5}&\plus{4}&\plus{3}&\plus{1}&\plus{5}&\plus{1}&\plus{1}&\plus{1}&\plus{1}&\plus{1}&\plus{1}&\plus{1}\\
\bottomrule
\end{tabularx}
\end{twocolumntable}
