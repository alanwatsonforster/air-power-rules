...
\begin{itemize}[nosep]
    ...
    \item PSSM aircraft = \plus{2.0} decel if any turns \changedin{1C}{1C-apj-23-errata}{or rolls}{and \plus{2.0} decel if any rolls} done, and reduce maximum turn rate by one but not to less than HT.
    \item Normal aircraft = \plus{1.0} decel if any turns \changedin{1C}{1C-apj-23-errata}{or rolls}{and \plus{1.0} decel if any rolls} done.
