...
\begin{enumerate}
    ...
    \item \changedin{1C}{1C-apj-23-errata/1B-apj-24-play-aids}{CHAFF PPL Effectiveness No.}{Chaff PPL Eff.\ No.\ \minus{} 1/2 radar ECCM (round \addedin{1C}{1C-apj-36-errata}{product }up).}
    \item Mini-Jammer PPL Effectiveness No.
    \item Aircraft Size Modifier from ADC.
    \itemdeletedin{1C}{1C-apj-23-errata/1B-apj-24-play-aids}{\plus{4} if aircraft has Stealth Technology.}
    \itemaddedin{1C}{1C-apj-23-errata/1B-apj-24-play-aids}{\minus{2} if target aircraft IFF on.}
...
\begin{onecolumntablefloat}
\begin{onecolumntable}
\addedin{1C}{1C-apj-23-errata/1B-apj-24-play-aids/1B-apj-25-qa}{
