...
\arcrange{180}{+}&\minus{1}, \minus{X}&\minus{0}, \minus{5}&\plus{1}, \minus{1}&\plus{3}, \minus{0.5}&\plus{5}, \plus{0}&\plus{X}, \plus{1}\\
\arcrange{150}{+}&\minus{0.5}, \minus{X}&\minus{0}, \minus{8}&\plus{2}, \minus{2}&\plus{4}, \minus{1}&\plus{8}, \plus{0}&\plus{X}, \plus{0.5}\\
\arcrange{120}{+}&\minus{0}, \minus{X}&\plus{0.5}, \minus{X}&\plus{4}, \minus{4}&\plus{6}, \minus{2}&\plus{X}, \minus{0.5}&\plus{X}, \plus{0}\\
\bottomrule
\end{tabularx}
\begin{tablenote}{0.8\linewidth}
