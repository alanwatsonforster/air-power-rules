...
\begin{twocolumntablefloat}
    \begin{twocolumntable}
        ...
        \footnotesize
        \begin{tabularx}{\linewidth}{P@{\hspace{1em}}P}
            \toprule
            ...
            \begin{enumerate}[nosep]
                ...
                \item \changedin{2A}{2A-unloaded-dives}{Diving flight}{Diving flight or unloading} may not follow Vertical climbs.
                \item Exception, High Pitch Rate aircraft may \changedin{2A}{2A-unloaded-dives}{enter Steep Dives or Unloaded Dives}{enter a Steep Dive or unload} the turn after.
        ...
        \begin{tabularx}{\linewidth}{P@{\hspace{1em}}P}
            ...
            \deletedin{2A}{2A-unloaded-dives}{
                ...
                \begin{enumerate}[nosep]
                    ...
                    \item FPs done while unloaded may not be used for turning or prep-moving.
            ...
            \begin{enumerate}[nosep]
                ...
                \item \changedin{2A}{2A-unloaded-dives}{When Steep or Unloaded dives follow a vertical dive; at least half an aircraft's FPs (round down) must be expended as VFPs or Unloaded HFPs; except High Pitch Rate aircraft need only expend 1/3 FPs as VFPs or unloaded HFPs.}{When a steep dive follows a vertical dive, at least half of an aircraft's FPs (round down) must be expended as VFPs, except High Pitch Rate aircraft need only expend 1/3 FPs as VFPs.}
            \end{enumerate}
            ...
            \addedin{2A}{2A-unloaded-dives}{
                ...
                \changedin{2B}{2B-unloaded-dives}{
                    \begin{enumerate}[nosep]
                        \item Level flight. One or two FPs are VFPs. The rest are HFPs.
                        \item The first VFP may only be used after half of the HFPs have been expended with the aircraft unloaded. The second VPF may only be used after all of the HFPs have been expended with the aircraft unloaded.
                        \item The aircraft loses 1 level on each VFP.
                        ...
                        \item All unloaded FPs done in a single game-turn must be done in one continuous string.
                        \item If all FPs are unloaded, the aircraft ends the turn in a steep dive.
                    \end{enumerate}
                }{
                    \begin{enumerate}[nosep]
                        \item Level flight. All FPs are HFPs.
                        \item All unloaded FPs in a game turn must be consecutive.
                        \item During the FP in which it expends unloaded FPs equal to half of its total FPs (round up), it loses one altitude level.
                        \item If all of its FPs are unloaded, the aircraft loses another altitude level in its last FP and is considered to end in a steep dive.
                        \item The aircraft gains 1.0 AP per level lost.
                        \item The aircraft may not make any attacks, aim, track, launch or guide weapons, or use radar while unloaded and until it completes a recovery period.
                        \item Unloaded FPs may not be used for turning flight or for preparing or executing any maneuver except a slide. An unloaded FP aborts a turn or maneuver.
                    \end{enumerate}
                }
            }
