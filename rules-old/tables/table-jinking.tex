...
\addedin{1C}{1C-apj-23-errata}{Reversing angle of bank when going directly from one turn to another still constitutes jinking if the A/C is shot at while reversing. Also when jinking turns may not be stretched out with extra FPs before facing.}
