...
\newcommand{\tightbinaryminus}[2]{\mbox{#1\textminus#2}}
...
\newcommand{\binarydivide}[2]{\mbox{#1\space\textdivision\space#2}}
\newcommand{\tightbinarydivide}[2]{\mbox{#1\textdivision#2}}

\newcommand{\lessthanbefore}[1]{\mbox{<#1}}
\newcommand{\lessthanorequaltobefore}[1]{\mbox{\textlessthanorequal#1}}
\newcommand{\greaterthanbefore}[1]{\mbox{>#1}}
\newcommand{\greaterthanorequaltobefore}[1]{\mbox{\textgreaterthanorequal#1}}

\newcommand{\binaryrelation}[3]{\mbox{#1\space#2\space#3}}
\newcommand{\tightbinaryrelation}[3]{\mbox{#1#2#3}}
\newcommand{\triperelation}[5]{\mbox{#1\space#2\space#3\space#4\space#5}}
