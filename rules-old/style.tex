...
\newcommand{\plus}[1]{+#1}
\newcommand{\plusafter}[1]{#1+}
\newcommand{\binaryplus}[2]{#1~+~#2}

\newcommand{\minus}[1]{−#1}
\newcommand{\minusafter}[1]{#1−}
\newcommand{\binaryminus}[2]{#1~−~#2}

\newcommand{\binaryplusorminus}[2]{#1~±~#2}

\newcommand{\multiplybefore}[1]{×#1}
\newcommand{\multiplyafter}[1]{#1×}
\newcommand{\binarymultiply}[2]{#1~×~#2}

\newcommand{\binarydivide}[2]{#1~/~#2}

\newcommand{\lessthanbefore}[1]{<#1}
\newcommand{\lessthanorequaltobefore}[1]{≤#1}
\newcommand{\greaterthanbefore}[1]{>#1}
\newcommand{\greaterthanorequaltobefore}[1]{>#1}
...
\newcommand{\figurecaption}[2]{
    \ifaids
        \par
        \medskip
        \textaddedin{1B}{1B-figures}{Figure~\ref{#1}: #2}
    \else
        \textaddedin{1B}{1B-figures}{\caption{#2\label{#1}}}
    \fi
}
