...
\let\original@tablecaption\tablecaption
\renewcommand{\tablecaption}[2]{
    \silentlychangedin{1B}{1B-tables}{
        \original@tablecaption{#1}{#2}
    }{
        \ifaids
            \textaddedin{1B}{1B-tables}{\textbf{TABLE~\ref{#1}: \MakeUppercase{#2}}}
        \else
            \textaddedin{1B}{1B-tables}{\caption{\MakeUppercase{#2}\label{#1}}}
        \fi
    }
    \par
    \medskip
...
\let\original@tablecaptioncontinued\tablecaptioncontinued
\renewcommand{\tablecaptioncontinued}[2]{
    \silentlychangedin{1B}{1B-tables}{
        \original@tablecaptioncontinued{#2}
    }{
        \textaddedin{1B}{1B-tables}{\textbf{TABLE~\ref{#1} (CONTINUED): \MakeUppercase{#2}}}
        \par
    }
    \medskip
}
...
\renewcommand{\figurecaption}[3][]{
    \ifaids
        \par
        \medskip
        \textaddedin{1B}{1B-figures}{\textbf{FIGURE~\ref{#2}: \MakeUppercase{#3}} {\normalfont #1}}
    \else
        \textaddedin{1B}{1B-figures}{\caption{\MakeUppercase{#3}\label{#2} {\normalfont #1}}}
    \fi
}
...
\newcommand{\simplefigurecaption}[1]{
    ...
    \medskip
    {\bfseries\MakeUppercase{#1}}\rule{0em}{3.2ex}
    \par
    \medskip
}
