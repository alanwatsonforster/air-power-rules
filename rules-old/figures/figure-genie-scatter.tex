...
\figurecaption[A first die roll determines the scatter direction. A second die roll, halved and rounded down, determines the scatter distance in hexes.]{figure:genie-scatter}{AIR-2 Genie Scatter.}
