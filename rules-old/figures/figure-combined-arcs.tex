...
\newcommand{\legendlineone}[6]{
    \draw (-0.1,#1)
        node [color=black,anchor=west] {%
            \wbox[r]{\triperelation{\plus{0}{<}}{#4} $\mbox{FS}$ \wbox[l]{$= \plus{\textinfinity}$}{$#5$}
        };
    \draw (8.0,#1)
        node [color=black,anchor=west] {%
           #6
...
\newcommand{\legendlinetwo}[7]{
    \draw (-0.1,#1) 
        node [color=black,anchor=west] {%
            \wbox[r]{\plus{0 <}}{$#5$} $\mbox{FS}$ \wbox[l]{$= \plus{\textinfinity}$}{$#6$}
        };
    \draw (8.0,#1)
        node [color=black,anchor=west] {%
           #7
...
\begin{combinedarcfigure}
    ...
    \drawgrid
    \begin{legend}
        \legendlineone{+4}{Tpurple}{dashed}{}{= \plus{\textinfinity}}{above}
        \legendlineone{+3}{Tred   }{solid }{+3 <}{< \plus{\textinfinity}}{above}
        ...
        \legendlineone{-3}{Tolive }{solid }{-3 >}{> \plus{\textinfinity}}{below}
        \legendlineone{-4}{Tcyan  }{dashed}{}{= \minus{\textinfinity}}{below}
    \end{legend}
...
\begin{combinedarcfigure}
    ...
    \begin{legend}
        \legendlineone{+4}{Tpurple}{dashed}{}{= \plus{\textinfinity}}{above}
        \legendlinetwo{+3}{Tred   }{dashed}{solid}{+3 <}{< \plus{\textinfinity}}{above}
        \legendlinetwo{+2}{Tgreen }{solid }{solid }{+1 <}{\le +3}{between}
        \legendlinetwo{+1}{Torange}{solid }{solid }{0 <}{\le +1}{between}
        \legendlinetwo{+0}{Tblue  }{solid }{solid }{}{= 0}{between}
        \legendlinetwo{-1}{Tbrown }{solid }{solid }{0 >}{ \ge -1}{between}
        \legendlinetwo{-2}{Tpink  }{solid }{solid }{-1 >}{ \ge -3}{between}
        \legendlinetwo{-3}{Tolive }{dashed}{solid }{-3 >}{> \plus{\textinfinity}}{below}
        \legendlineone{-4}{Tcyan  }{dashed}{}{= \minus{\textinfinity}}{below}<
    \end{legend}
...
\figurecaption{figure:combined-arcs-b}{Combined arc vertical limits for the \arcplus{180} arc.}
...
\figurecaption{figure:combined-arcs-c}{Combined arc vertical limits for the \arcplus{150} arc.}
...
\figurecaption{figure:combined-arcs-d}{Combined arc vertical limits for the \arcplus{120} arc.}
...
\begin{combinedarcfigure}
    ...
    \drawgrid
    \begin{legend}
        \legendlineone{+4}{Tpurple}{dashed}{}{= \plus{\textinfinity}}{below}
        \legendlinetwo{+3}{Tred   }{dashed}{solid}{+3 <}{< \plus{\textinfinity}}{below}
        \legendlinetwo{+2}{Tgreen }{dashed}{solid }{+1 <}{\le +3}{below}
        \legendlinetwo{+1}{Torange}{solid }{solid }{0 <}{\le +1}{between}
        \legendlinetwo{+0}{Tblue  }{solid }{solid }{}{= 0}{between}
        \legendlinetwo{-1}{Tbrown }{solid }{solid }{0 >}{ \ge -1}{between}
        \legendlinetwo{-2}{Tpink  }{dashed}{solid }{-1 >}{ \ge -3}{above}
        \legendlinetwo{-3}{Tolive }{dashed}{solid }{-3 >}{> \plus{\textinfinity}}{above}
        \legendlineone{-4}{Tcyan  }{dashed}{}{= \minus{\textinfinity}}{above}
    \end{legend}
...
\figurecaption{figure:combined-arcs-e}{Combined arc vertical limits for the \arcminus{90} arc.}
...
\figurecaption{figure:combined-arcs-f}{Combined arc vertical limits for the \arcminus{60} arc.}
...
\figurecaption{figure:combined-arcs-g}{Combined arc vertical limits for the \arcminus{30} arc.}
