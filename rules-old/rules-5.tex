...
\addedin{1B}{1B-apj-36-errata}{When an expenditure of 2/3 of an aircraft's speed (or FPs) is required, use the 2/3 entry from \changedin{1C}{1C-tables}{the chart}{Table~\ref{table:fractions}}, not \binarymultiply{2}{1/3}. Drop all fractions read off the chart.}
