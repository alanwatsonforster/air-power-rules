...
Each door gun may fire independently. It may conduct one air-to-ground strafing attack on any ground target in its arc within two hexes of range. Aiming is not required and there are no modifiers. Alternatively, it may return fire on any aircraft in its arc carrying out a gunnery attack. The roll to hit is \minusafter{1} and there are no modifiers.
