...
\begin{itemize}
    ...
    Note: Normally, only one switch is allowed.  Some ARMs may be allowed more (see \changedin{1B}{1B-tables}{ARM Data Table notes}{Table \ref{table:stores-ARM}}).
