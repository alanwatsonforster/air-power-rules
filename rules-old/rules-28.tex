...
%\paragraph{Wind Corrected Munitions Dispenser.}  The WCMD uses an inertial navigation system (INS) guided munitions dispenser.  It operates like a guided bomb, attacking with a \minus{2} modifier.
