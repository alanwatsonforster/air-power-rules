...
%The target is a GPS coordinate in a hex; not the actual targeted facility.  Thus, no modifiers apply for camouflage. The target need only be in the \arcrange{120}{+} arc of the aircraft when the weapon is released.  
...
%Any targets other than a fixed location in the hex are attacked as collateral damage under Rule 21.3 if using GPS guidance.
