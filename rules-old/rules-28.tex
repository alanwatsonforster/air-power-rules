...
%The target is a GPS coordinate in a hex; not the actual targeted facility.  Thus, no modifiers apply for camouflage. The target need only be in the 120+ arc of the aircraft when the weapon is released.  
