...
\begin{itemize}
    ...
    \item In combat: Gun attacks, visual bombing or rocket attacks, \changedin{1C}{1C-apj-22-qa/1B-apj-39-qa}{and IRM launches}{IRM launches, and the use of auto-track and boresight radar modes}.
\end{itemize}
