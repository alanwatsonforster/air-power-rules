...
\paragraph{Egressing Doomed Aircraft.} Pilots and crew will automatically attempt to eject or, if not ejection seat equipped, bail out from destroyed aircraft the instant the kill occurs. They may also elect to abandon undamaged or damaged aircraft at any point in the game-turn \deleted{2B}{2B-gloc-egress}{(unless GLOC'd) }during the aircraft's movement by simply declaring it.  \addedin{2B}{2B-gloc-egress}{The pilot of a pilot-only aircraft may not eject if they are unconscious. However, any conscious crewmember can eject himself and all other crewmembers, including unconscious ones. A crewmember may not bail out if they are unconscious.} Once declared and after any proportional moves and/or attacks by pursuing missiles are resolved, the egress attempt is rolled for. Only one attempt per game-turn is allowed.
