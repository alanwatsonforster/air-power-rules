...
\addedin{1C}{1C-apj-22-qa/1B-apj-35-qa/1B-apj-36-errata}{A turn that is carried over from one game-turn to the next must be considered for decel in both game-turns. If it corresponds to the highest turn rate during both game-turns, the decel will be paid twice.}
...
\notein{1C}{AWF: FH in the APJ 36 errata stated that the penalty was for each 30 degrees of facing change, 1B-apj-38-qa stated that this was a change in the 2nd edition rules.}
