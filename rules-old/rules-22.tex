...
%Aiming always ceases as soon as the aircraft commences firing\changedin{2R}{2R-multiple-strafing-attacks}{, however, the aiming modifiers may be retained for both shots and over into the next game-turn for additional shots as long as all the shots are still at the original target}{. As a special case, aiming is not required for a second strafing attack (or subsequent ones on following game turns) on the same target provided the aircraft continues to move along the approach line with its wings level, without declaring a turn, and without preparing for a maneuver, until it carries out the attack. However, the accumulation of additional FPs for aiming modifiers is not permitted; instead, these attacks use the same aiming modifier as the first attack} If strafing is shifted to a different target in the same or different hex, \addedin{2R}{2R-multiple-strafing-attacks}{or fails to move along the approach line with its wings level, without declaring a turn, and without preparing for a maneuver, }aiming must be done anew.

\changedin{2R}{2R-multiple-strafing-attacks}{Aiming always ceases as soon as the aircraft commences firing, however, the aiming modifiers may be retained for both shots and over into the next game-turn for additional shots as long as all the shots are still at the original target.}{After a strafing attack, an aircraft may continue aiming at the same target and may carry out subsequent strafing attacks without aiming again. However, it may not accumulate additional FPs for aiming modifiers; the second and subsequent strafing attacks use the same aiming modifier as the first. If strafing is shifted to a different target in the same or different hex, aiming must be done anew.\par}
