...
Aiming always ceases as soon as the aircraft commences firing, however, the aiming modifiers may be retained for both shots and over into the next game-turn for additional shots as long as all the shots are still at the original target. \addedin{2R}{2R-multiple-strafing-attacks}{That is, under this rule, the aiming modifier for subsequent attacks on the same target is the same as for the first attack. }If strafing is shifted to a different target in the same or different hex, aiming must be done anew.
