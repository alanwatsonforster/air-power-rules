...
\begin{itemize}
    ...
    \item it\deletedin{1C}{1C-apj-35-qa/1C-apj-39-qa}{ vertical climbed, it vertical dived, or} used an unloaded dive\addedin{1C}{1C-apj-36-errata}{ and has not recovered by the end of its move}.
...
\begin{itemize}
    ...
    \item it\deletedin{1C}{1C-apj-35-qa/1C-apj-39-qa}{ vertical climbed, it vertical dived, or} used an unloaded dive.
