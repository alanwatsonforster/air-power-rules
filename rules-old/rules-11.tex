...
\paragraph{Visual Sighting Procedure.} In the Visual Sighting Procedure Phase, \changedin{3A}{3A-searcher}{the friendly aircraft which is closest to\addedin{1B}{1B-apj-23-errata/1B-apj-35-qa}{, and not blind to or blocked by clouds,} an unsighted or unpadlocked enemy aircraft or missile is used as the reference aircraft for sighting attempts against it. If more than one friendly aircraft is the same distance from an enemy, the searching player may designate which of the friendly aircraft will be the searcher.}{for each unsighted enemy aircraft, the searching player may designate any friendly aircraft as the searcher provided that aircraft is within sighting range, is not blind to the target, does not have a line of sight blocked by clouds or terrain, and has at least one crewmember who is not unconscious or disoriented. An aircraft may be the searcher for any number of sighting attempts.} \addedin{1B}{1B-apj-23-errata/1B-apj-35-qa}{All aircraft on a side within sighting range \addedin{1B}{1B-apj-25-qa}{of and not blind to an enemy }may participate in the sighting attempt of that enemy even if they were used to padlock other targets in the same sighting phase.}
