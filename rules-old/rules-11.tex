...
Each pilot-only crewed friendly aircraft may padlock one target. Each multi-crew aircraft may padlock two targets instead of one. Crew quality (see Chapter 18) may also affect how many padlocks are possible.
