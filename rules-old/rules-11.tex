...
\paragraph{Sighting and Defensive Preemption.} A moving enemy aircraft may not be defensively preempted against (see rule \ref{rule:defensive-preemptions}) unless:
...
\paragraph{Sighting \& Defensively Engaging Missiles.} An enemy missile may not be defensively engaged (see rule \ref{rule:engaging-missiles}) unless;
...
\addedin{1C}{1C-apj-36-errata}{\paragraph{Initial Spotting.} When a scenario provides information on initial spotting, this applies to 'game-turn 0'. The normal spotting rules should be followed starting with game-turn 1, taking into account possible padlocks due to previous spotting.}
...
\addedin{1C}{1C-apj-22-qa}{\paragraph{Padlocking.} If an aircraft chooses to padlock sighted ground units in the following turns, they remain sighted to it. If the aircraft elects to sight aircraft or missiles, or it cannot padlock the ground units, they become unsighted and must be sighted anew later.
}
...
\begin{advancedrules}
    ...
    \paragraph{IRSTS Types.} \changedin{2A}{2A-irsts-c}{Two types of IRSTS systems exist: A (Early) and B (Advanced)}{Three types of IRSTS systems exist: A (Early), B (Modern), and C (Advanced)}. IRSTS is used in the Radar Search and Lock-On Phase. A single pilot aircraft may use radar or IRSTS in this phase, a multi-crew aircraft may do both. \addedin{1C}{1C-apj-25-qa}{Unlike radar, there are no maneuver-related restrictions on the use of IRSTS.}
    ...
    \paragraph{I.D. Procedure.} 
    Visual identification of ground and Naval units may occur before a unit is attacked or fires. 
    \changedin{2W}{2W-ground-unit-identification}{Aircraft may attempt to visually I.D. targets in the sighting phase after sighting them.}{Aircraft may attempt to visually I.D. sighted ground and naval units in the sighting phase, including in the phase in which they are first sighted.}
