...
\item
If the aircraft has a flight slope of more than 3 but that is still finite (\binaryrelation{3 < \mbox{FS} }{<}{ +\infinity}), Table~\ref{table:vertical-limit-factors} gives one mixed factor (without parentheses) of \plus{2.0} and one pure factor (with parentheses) of (\plus{+7}).
...
\item
If the aircraft in a pure vertical climb (\binaryrelation{\mbox{FS} }{=}{ +\infinity}), Table~\ref{table:vertical-limit-factors} gives only one pure factor (with parentheses) of (\plus{+3}).
