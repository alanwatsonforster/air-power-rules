...
\begin{itemize}
    ...
    \item\itemparagraph{Type-A:} These may place a laser spot anywhere in the aircraft's \arcrange{180}{+} arcs if operated by the pilot, or within the \arcrange{120}{+} arcs if used by the weapons officer. The maximum range a laser spot may be placed from the aircraft is 18 hexes (counting altitude).
