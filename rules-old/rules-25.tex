...
\begin{itemize}
    ...
    \item\itemparagraph{Command Guided (CG).} Keep the target within the missile's \arcrange{120}{+} arc.

    \item\itemparagraph{Continuous Wave Guided (CW).} Keep the target within the missile's \arcrange{150}{+} arc.
