...
\paragraph{Aiming.} An aircraft aims its weapons by approaching a sighted target along a LOA in level or diving flight. It must maintain its approach for a specified period of time expressed in terms of FPs expanded in flight while on the LOA. \changedin{1B}{1B-tables}{The Aiming Time Table}{Table \ref{table:aiming}} shows the time required (which depends on the type of bombsight used).
