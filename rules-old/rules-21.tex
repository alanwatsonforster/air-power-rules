...
\item Tracking Time: For each 1/3rd of an aircraft's speed in FPs expended as additional aiming beyond the minimum required, a -1 is applied. Up to a maximum of \changedin{1C}{{1C-apj-23-errata}}{-3}{-2} may be accrued by extra aiming.
\end{itemize}
