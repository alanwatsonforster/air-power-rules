...
\subsection{Aircraft and Missile Counters}
...
\changedin{3A}{3A-ship-facing}{
    \subsection{Ground and Naval Unit Counters}
    ...
    \subsection{Ground Unit Counters}
...
\subsection{Collision Exceptions} There are \changedin{1C}{1C-apj-36-errata}{two}{three} exceptions to the Potential Collision rule.
