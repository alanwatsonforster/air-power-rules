...
Each ground unit counter has a position which is defined simply by its map location. They are always placed wholly within hexes and never on hexsides. Ground units never consider facing (except heavy AAA units under advanced rule 24.5). See Figure~\ref{figure:map-location-for-ground-units}.
...
\begin{itemize}
    ...
    \itemaddedin{1B}{1B-apj-36-errata}{An aircraft that has already rolled for a collision for a head-on gun attack \addedin{2B}{2B-collisions}{at the end of its move }does not roll again for a collision at the end of the flight phase.}
\end{itemize}
