...
\paragraph{Toss Restrictions and Modifiers.} Toss bombing may not be done if the release point is more than six hexes away from the target. Toss bombing keeps you further away from point defenses but is less accurate. There is a Toss bomb attack modifier to the die roll of $+1$ per hex away from the target at release.  
