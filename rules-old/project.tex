...
\begin{itemize} 
\itemtag{2R-expending-fps} Clarify an FP is considered to have been expended as soon as the aircraft finishes the movement associated with that FP and before any immediately subsequent turn completions or attacks.
\end{itemize}
