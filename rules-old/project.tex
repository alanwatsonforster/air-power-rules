...
\begin{itemize}
    ...
    \itemtag{2B-ewr-eccm} EWR ECCM is always 0 in TSOH, but it could be different for more moder radars. I have added a rule that it can be different if specified in scenario notes.
