...
\begin{itemize}
    ...
    \item{3A-same-hex-arcs} For gun attacks, the arc at the same location is the same as if the attacker were to be moved backwards one hex.
    ...
    The rules for the arc at the same location has been changed (to be the same as it would be if the distant element was moved back one hex). The rules for borderline cases for missile launch requirements and IRM target aspect requirements have been clarified to match those for missile attacks.
