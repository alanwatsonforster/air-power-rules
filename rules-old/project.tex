...
\begin{itemize}
    ...
    \item\changetag{2R-multiple-strafing-attacks}
    
    %Clarify that the aiming modifier for second subsequent strafing attacks on the same target is the same as for the first. Clarify that the aircraft must continue to fly wings level, without turning, and without maneuvering.
