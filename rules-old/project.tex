...
\begin{itemize}
    ...
    \itemtag{2B-multiple-dds} If an aircraft has two or more DDS systems (e.g., one integrated and the other in a pod), each can have their own DDS program and any combination of them can be turned on or off each game turn, provided other requirements are met.
...
\begin{itemize}
    ...
    \itemtag{2W-ground-unit-identification} 
    Clarify that aircraft can attempt to identify ground and naval units in the same game turn in which they are first sighted.
