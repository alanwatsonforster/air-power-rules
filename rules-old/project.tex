...
\begin{itemize}
    ...
    \item\changetag{2B-fractions}
        ...
        State explicitly, the fractions table is used for:
        \begin{itemize}
...
\begin{itemize}
    ...
    \item\changetag{2R-ground-unit-identification}
...
\begin{itemize}
    ...
    \item\changetag{2W-rpt}

        Rules that apply to RPs also apply to RPTs.
