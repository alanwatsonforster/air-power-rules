...
\begin{itemize}   
    \itemtag{2R-preemption} The rules explicitly allow preemption before the first FP expended by a threatening aircraft. However, the original procedure does not permit this, as preemption is declared \emph{after} each FP. The procedure is changed so that preemption is declared \emph{before} each FP.
\end{itemize}
