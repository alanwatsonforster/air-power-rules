...
\begin{itemize}
    ...
    \item The first-edition {\AirPow} rules were published in 1992 in {\TSOH}. There are two sets of official errata: one page provided with {\TSOH} and four pages published in {\APJ} \#24.
...
\begin{itemize}
    ...
    This corresponds to the first-edition {\AirPow} rules without any errata.
    ...
    This version has corrected and redrawn diagrams, corrected tables, and incorporates both into the body of the text in addition to the play aid sheets.
