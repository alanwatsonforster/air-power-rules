...
\begin{itemize}
    ...
    \itemtag{1C-tsoh-errata} All changes in the single sheet of errata included with {\TSOH}, specifically: the replacement of one of the panels Figure 9.2 (Horizontal Arcs); additions of new Tables 19.1 (Internal DDS) and 20.1 (Terrain Effects); and a new note to Figure 19.1 (Jamming Cell Formations).    
