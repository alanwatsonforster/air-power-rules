...
\begin{itemize}
    ...
    \itemtag{2R-fuel-tank-weight-and-load} The weight of a fuel tank scales linearly with the fraction of fuel it contains. The empty load is only used when the tank is completely empty, otherwise the full load is used.
