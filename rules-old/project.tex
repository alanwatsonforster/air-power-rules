...
\begin{itemize} 
    \itemtag{2R-random-plotted-fire} Added text to the random AAA fire table on determining the range of the plotted fire hex from the target aircraft. This text appears in the rules, but is missing from the original table.
\end{itemize}
