...
\IfStrEq{\thisversion}{2R}{
    \newcommand{\earlierversion}{2B}
    \newcommand{\earlierversions}{1A1B1C2A2B}
}{}
\IfStrEq{\thisversion}{2W}{
    \newcommand{\earlierversion}{2R}
    \newcommand{\earlierversions}{1A1B1C2A2B2R}
}{}
\IfStrEq{\thisversion}{3A}{
    \newcommand{\earlierversion}{2B}
    \newcommand{\earlierversions}{1A1B1C2A2B}
}{}
\IfStrEq{\thisversion}{3R}{
    \newcommand{\earlierversion}{3A}
    \newcommand{\earlierversions}{1A1B1C2A2B3A}
}{}
\IfStrEq{\thisversion}{3W}{
    \newcommand{\earlierversion}{3R}
    \newcommand{\earlierversions}{1A1B1C2A2B2R2W3A3R}
}{}
...
\IfSubStr{\thissubversion}{Changes}{
    ...
    \newcommand{\tablerowaddedin}[3]{%
        \ifthisversion{#1}{\added{\scriptsize Next row added:\endnote{Added in #2.}}\\#3\\}%
        \ifearlierversion{#1}{#3\\}%
        \ignorespaces
    }
    \newcommand{\tablerowdeletedin}[3]{%
        \ifthisversion{#1}{\deleted{\scriptsize Next row deleted:\endnote{Deleted in #2.}}\\#3\\}%
        \iflaterversion{#1}{#3\\}%
        \ignorespaces
    }
}{
