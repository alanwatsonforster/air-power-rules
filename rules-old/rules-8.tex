...
\deletedin{2R}{2A-unloaded-dives}{
...
\addedin{2R}{2A-unloaded-dives}{

\section{Unloaded Dives}
...
%\changedin{2W}{2B-unloaded-dives}{An aircraft may only unload in level flight}{An aircraft may only unload in level flight, and as usual for level flight all of its FPs are HFPs}. An aircraft may begin to unload at any point in its flight. All unloaded \changedin{2W}{2B-unloaded-dives}{FPs}{HFPs} in a game turn must be in a single, continuous series. \changedin{2W}{2B-unloaded-dives}{An aircraft that unloads for at least half of its FPs loses one altitude level using a VFP. An aircraft that unloads for all of its FPs loses a second altitude level at the end and is considered to end its move in a SD.}{During the FP in which it has expended half of its FPs (round down) as unloaded FPs, it loses one altitude level. If it unloads for all of its FPs, during its last FP it loses a second altitude level.} It receives 1.0 accel point per altitude level lost.

%While unloading, an aircraft may not turn or execute any maneuver except a slide. An aircraft may not conduct attacks, aim, track targets, or launch weapons if the preceding FP was unloaded. It must complete a recovery period after its last unloaded FP before it can carry out these actions.
