...
\deletedin{2W}{2W-unloaded-dives}{
...
\begin{itemize}
    ...
    \item\itemparagraph{UD Restrictions:} An aircraft spending unloaded HFPs may not conduct any attacks, aim, track targets or launch weapons. \addedin{1C}{1C-apj-36-errata}{Recovery Periods also apply to the prohibition from conducting combat actions and radar work following unloaded dives. If you unload at the beginning of turn and then expend sufficient FPs to meet the recovery period after the last unloaded FP is spent, then you may still launch missiles, conduct attacks or radar work that turn.}
     ...
     \item\itemparagraph{UD Accel Points:} \changedin{2A}{2A-unloaded-dives}{On the first turn of \changedin{1C}{1C-apj-36-errata}{ an UD, the aircraft}{diving flight, an aircraft in a UD} receives 0.5 accel points per altitude level lost; on \changedin{1C}{1C-apj-36-errata}{subsequent turns of continued diving, it}{the second or subsequent consecutive turns of diving flight, an aircraft in a UD} receives 1.0 accel point per altitude level lost.}{An aircraft in a UD receives 1.0 AP per altitude level lost.}
...
\addedin{2W}{2W-unloaded-dives}{

\section{Unloaded Dives}

An aircraft may use an unloaded dive (UD) to rapidly accelerate. It dives to match the fall of gravity; this causes weightlessness and eliminates induced drag. The potential advantage over a steep dive is the horizontal distance covered.

\begin{itemize}

    \item\itemparagraph{UD Prerequisites:} An aircraft may not unload on the game turn following a vertical dive. If it did not unload on the previous game turn, it may unload in level flight or a steep dive. If it did unload on the previous game turn, it may unload in a steep dive. An aircraft may not unload on three consecutive game turns.

    \item\itemparagraph{UD Procedure:} Expend one or more HFPs or VFPs as unloaded. As soon as the aircraft expends unloaded FPs equal to at least {\onethird} of its speed, it loses one level. As soon as it expends unloaded FPs equal to at least {\onehalf} its speed, it loses a second level. As soon as it expends unloaded FPs equal to {\twothirds} of its speed, it loses a third level.

    \item\itemparagraph{UD Limits:} All unloaded FPs must be expended in a continuous series. They may be spent at the beginning, end or in the middle of the aircraft's flight. Unloaded FPs may not be used for turning flight or for preparing for or executing any maneuver except a slide. The rest of the FPs may be expended normally for maneuvering purpose. 

    \item\itemparagraph{UD Restrictions:} An aircraft may not conduct attacks, aim, track targets, or launch weapons if the preceding FP was unloaded. It must complete a recovery period after its last unloaded FP before it can carry out these actions.

     \item\itemparagraph{UD Accel Points:} An aircraft in an UD receives 1.0 accel point per altitude level lost.
