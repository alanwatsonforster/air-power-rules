...
During the FP in which it expends unloaded FPs equal to half of its total FPs (round up), it loses one altitude level.
If it unloads for all of its FPs, during its last FP it loses a second altitude level and ends the game turn in a steep dive.
It receives 1.0 accel point per altitude level lost.
...
\addedin{2R}{2R-unloading-and-damage-control}{
