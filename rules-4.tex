...
\addedin{1B}{JDW in the TSOH errata}{\paragraph{Over-Loading Stations.} An aircraft may overload any of its weapon stations in terms of weight by up to 20\%. However, its maximum turn capability is reded by one (i.e., from BT to HT) until all overloaded stations are back within limits. Though stations may be overloaed, the aircraft's total load limit may never be exceeded.}

\addedin{1B}{JDW in the TSOH errata}{\paragraph{Symmetric Loading Requirements.} When picking loads for aircraft, the initial weight carried on one winf must be within 20\% of that carried on the other wind unless the total weight on wach wing is 10\% or less of the aircraft's load limit.}
