...
Snap-fired missiles roll for launch with a $+3$ modifier as there is a possibility that they will be out of position to receive guidance signals when, and if, a lock-on is achieved to the target. If, in the immedi-ately ensuing Air Radar phase, a lock-on is not achieved, the missiles are removed from play.

\subsection{Radar Missile Out en Envelope Shots}
