...
\paragraph{EXPANDED SEQUENCE OF PLAY.} In the play aids to these rules, there is an expanded SOP chart which fully details each of the actions players will be concerned with in each phase of the game-turn.