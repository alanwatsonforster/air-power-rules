...
\begin{itemize}
    ...
    \item\itemparagraph{ZC Decel Points:} In the first turn of \changedin{1C}{FH in APJ 36 errata}{a Zoom Climb, the aircraft}{climbing flight, an aircraft in a ZC} receives 1.0 decel point per altitude level gained; on \changedin{1C}{FH in APJ 36 errata}{subsequent consecutive turns of ZC, the aircraft}{the second or subsequent consecutive turns of climbing flight, an aircraft in a ZC} receives 1.5 decel points per altitude level gained.
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item If the \changedin{1B}{JDW in the APJ 23 errata}{value is 1.0 to 1.5}{CCC value is 1.0 to 2.0}, then up to 2/3ds the FPs may be VFPs and the first VFP gains \changedin{1C}{FH in APJ 36 errata}{any fraction}{either any fraction or 1 level} and the rest gain 1 level each.
        \item If the \changedin{1B}{JDW in the APJ 23 errata}{value is 2.0 or more}{CCC value is greater than 2.0}, then up to 2/3ds the FPs may be VFPs and \changedin{1C}{JDW in APJ 34}{each may gain 1 or 2 levels}{the first gains 1 level plus any fraction and the rest gain 1 or 2 levels each}.
    \end{enumerate}
    ...
    \addedin{1C}{FH in APJ 36 errata}{For purposes of computing SC decel, 
...
An aircraft in diving flight selects one of three types of dive: Steep Dive, Unloaded Dive, or Vertical Dive. Diving flight is handled in a manner similar to climbing flight. \changedin{1C}{FH in APJ 36 errata}{For purposes of maintaining dive speeds (rule 6), at least two or more altitude levels must be lost in a game turn through diving flight.}{
...
\begin{itemize}
    ...
    \item\itemparagraph{SD Accel Points:} On the first turn of \changedin{1C}{FH in APJ 36 errata}{steep diving, the aircraft}{diving flight, an aircraft in a SD} receives 0.5 accel points per altitude level lost; on \changedin{1C}{FH in APJ 36 errata}{subsequent turns of continued diving, it}{the second or subsequent consecutive turns of diving flight, an aircraft in a SD} receives 1.0 accel points per altitude level lost.
...
\begin{itemize}
    ...
    \item\itemparagraph{UD Restrictions:} An aircraft spending unloaded HFPs may not conduct any attacks, aim, track targets or launch weapons. \addedin{1C}{FH in APJ 36 errata}{Recovery Periods also apply to the prohibition from conducting combat actions and radar work following unloaded dives. If you unload at the beginning of turn and then expend sufficient FPs to meet the recovery period after the last unloaded FP is spent, then you may still launch missiles, conduct attacks or radar work that turn.}

     \item\itemparagraph{UD Accel Points:} On the first turn of \changedin{1C}{FH in APJ 36 errata}{ an UD, the aircraft}{diving flight, an aircraft in a UD} receives 0.5 accel points per altitude level lost; on \changedin{1C}{FH in APJ 36 errata}{subsequent turns of continued diving, it}{the second or subsequent consecutive turns of diving flight, an aircraft in a UD} receives 1.0 accel point per altitude level lost.
...
\begin{itemize}
    ...
    \itemaddedin{1B}{JDW in the APJ 23 errata}{\itemparagraph{VD Prerequisites.} To enter a VD, the aircraft must have used diving flight the turn before (exception: the Half Roll and Dive maneuver allows VDs to be entered from level flight, see rule 13.3.5).}
