...
\paragraph{Free Descents in Level Flight.} An aircraft in level flight may choose to take a free descent and lose one altitude level during its move. 
...
The sequence of play (rule~\ref{rule:phases}) is still not required, and you may ignore it.
}
}
