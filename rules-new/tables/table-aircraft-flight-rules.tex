...
\begin{enumerate}[nosep]
    ...
    \item If speed $\ge$ Mach 1, each 3.0 accel = \plus{0.5} speed for normal aircraft and each 2.0 = \plus{0.5} for Rapid Accel aircraft.
...
\begin{enumerate}[nosep]
    ...
    \item Shift in direction of roll (see \changedin{1C}{1C-figures}{diagram}{Figures~\ref{figure:displacement-roll-maneuvers} and \ref{figure:lag-roll-maneuvers}}) and optionally face 30 degrees in direction opposite to roll.
...
\begin{enumerate}[nosep]
    ...
    \itemaddedin{1B}{1B-apj-39-qa}{If done in climbing or diving flight, 1 altitude level may be gained or lost upon executing each roll after the first at no additional FP cost.}
