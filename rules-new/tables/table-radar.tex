...
\begin{enumerate}
    ...
    \item \changedin{1B}{1B-apj-23-errata/1B-apj-24-play-aids}{CHAFF PPL Effectiveness No.}{Chaff PPL Eff.\ No.\ $-$ $1/2$ radar ECCM (round \addedin{1B}{1B-apj-36-errata}{product }up).}
    \item Mini-Jammer PPL Effectiveness No.
    \item Aircraft Size Modifier from ADC.
    \itemdeletedin{1B}{1B-apj-23-errata/1B-apj-24-play-aids}{$+4$ if aircraft has Stealth Technology.}
    \itemaddedin{1B}{1B-apj-23-errata/1B-apj-24-play-aids}{$-2$ if target aircraft IFF on.}
...
\midrule
\multirow{8}*{Detection Roll}&\multirow{8}*{From Table \ref{table:radar-searches}}&\multirow{8}*{---}&\multirow{8}*{---}&\multirow{8}*{\minitable{l}{Automatic for\\ closest sighted\\ target.}}&\multicolumn{1}{L}{Automatic for closest target or $7-$ for other sighted target. Friendly aircraft using IFF are ignored.}\\
\midrule
