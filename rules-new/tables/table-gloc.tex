...
\begin{itemize}
    ...
    \item Roll one die for each crewmember. On a \minusafter{1}, the crewmember suffers GLOC.
...
\addlinespace
All crewmembers recover automatically in the aircraft administrative phase of the second game turn following the one in which GLOC occurred.\\
\addlinespace
\bottomrule
\end{tabularx}
}
...
% ISSUE: A single turn or a sustained turn?
