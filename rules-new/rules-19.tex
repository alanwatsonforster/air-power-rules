...
Subtract the ECCM rating of the jammed radar from the \CX{barrage}{active} jammer rating and apply is as a die roll modifier for any search, passdowns, and/or lock-on attempts by the radar.
...
\notein{1B}{AWF: the TSOH errata states, “All aircraft in a jamming cell must be \plus{} or \minus{} one altitude level for increased jammer effectiveness.” This is included in the errata above.}    
