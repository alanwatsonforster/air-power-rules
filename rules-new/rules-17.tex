...
\begin{itemize}
    ...
    For example, consider an attack by an AIM-4F Super Falcon on a target at altitude level 4 flying above ground with an altitude level of 1. Table~\ref{table:missile-data} gives an ECCM rating of 1. The result of the calculation is $6 + 1 - 4 - 1 = \plus{2}$. Since this is positive, it would be applied as a die roll modifier.
