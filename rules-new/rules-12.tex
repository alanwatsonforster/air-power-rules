...
\begin{itemize}
   ...
   \item\itemparagraph{First Kill.} The side which achieves the first aircraft kill in the scenario receives a modifier of \plus{1}.
    ...
    \begin{itemize}
        \item An aircraft not in a close or tactical formation receives a \minus{1} modifier, unless at least one of its crewmembers is a veteran.
        \item A winger in a tactical formation with an initiative modifer that is less than that of the formation’s leader may  receives a \plus{1} modifier. (reflecting teamwork and radio calls).
        \item A winger in a tactical formation lead by a combat hero receives a \plus{1} modifier.
        \item If a combat hero is shot down, all pilots in their \emph{original} formation suffer a \minus{1} modifier. This modifier applies whether or not the combat hero was the leader of the formation.
    \end{itemize}
...
\label{rule:positions-of-advantage}
\label{rule:advantage-categories}
...
\begin{itemize}
    \item It is free.
    \item The enemy aircraft is in its \arcrange{150}{+} \AY[3A-horizontal-arcs]{horizontal} arc.
...
\item It has one or more friendly aircraft that have not yet moved in its \arcrange{150}{+} \CY[3A-horizontal-arcs]{horizontal} arc and at a range of no more than six hexes, and
