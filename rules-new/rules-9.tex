...
\begin{itemize}
    ...
    If the attacker is climbing and the target is diving or if the attacker is diving and the target is climbing, the modifier is $+2$. 

    If the attacker is climbing or diving and the target is in level flight\AY[3A-vertical-attacks]{ or if the attacker is in level flight and the target is climbing or diving}, the modifier is $+1$.
    ...
    If the attacker is climbing or diving and the target is in level flight or if the attacker is in level flight and the target is climbing or diving, the modifier is $+1$. 
