...
\addedin{2A}{2A-cruise}{\section{Cruise Speed} The cruise speed of an aircraft depends on its configuration. The cruise speed given on the ADC is for CL configuration. If the configuration is 1/2, reduce the cruise speed by 0.5. If the configuration is DT, reduce the cruise speed by 1.0.}
