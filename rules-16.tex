...
\begin{itemize}
    ...
    \item it performed any rolling maneuvers, VIFF Maneuvers, or a Vertical Reverse.

    \item it vertical climbed, it vertical dived, or it used an unloaded dive.
...
Exception for 120° arcs.  Aircraft with 120+ arcs (ASEA and PESA technology) continue to operate in the 120+ arc in Auto-Track Mode.
