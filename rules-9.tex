...
\paragraph{Die Roll Modifiers.} The roll to hit is modified by a variety of circumstances. The possible modifiers are summarized here and in \changedin{1C}{1C-tables}{the play aid tables}{Table~\ref{table:air-to-air-gun-and-rocket-modifiers}}:
