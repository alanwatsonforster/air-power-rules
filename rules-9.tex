...
\addedin{1C}{FH in APJ 36}{The procedure used to obtain horizontal range in Air to Air Gunnery is not the same as in the rest of the game; use the Legal Target Positions Diagram on the Play Aids Diagrams: Page 1. The hollow triangle represents the target occupying the same hex/hexside as the firer, though it could be at a different altitude. Such a situation would result in a range 0 shot if the altitude difference were 1 or 0.}
