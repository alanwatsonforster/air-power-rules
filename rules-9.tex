...
Consult figures~\ref{figure:angle-off-facing-hex-corner}, \ref{figure:angle-off-facing-hex-side}, and \ref{figure:angle-off-on-hex-side} according to the map location of the target. Often the attacking aircraft or missile will unambiguously be in an angle-off arc. 

However, sometimes the attacker will be located on the borderline between two arcs. To resolve these cases, consider the speeds of the attacker and target at the start of the game turn:
\begin{itemize}
...
For example, consider Figures~\ref{figure:angle-off-facing-hex-side}, \ref{figure:angle-off-facing-hex-corner}, \ref{figure:angle-off-on-hex-side} in which the aircraft A are targets and the aircraft B and C are attackers.
