...
\begin{itemize}
    ...
    \itemparagraph{Superficial Damage.} The hit has no affect.

    \itemparagraph{Light Damage.} The aircraft experiences some performance loss.
    
    \itemparagraph{Heavy Damage.} The aircraft experiences major performance loss and/or systems damage.

    \itemparagraph{Crippled.} The aircraft is heavily damaged and possibly combat ineffective.
    
    \itemparagraph{Killed.} The aircraft is destroyed. Remove the aircraft counter from play.
...
\paragraph{Previous Damage Effect.} If the aircraft was previously damage, the hitting weapon's attack rating is increased one.

\paragraph{Damage Table Modifiers.} The damage table die roll is modified for the following:

\begin{itemize}

    \itemparagraph{A/C Vulnerability.} The target's Vulnerability shown on the ADC is used directly as a modifier to the die roll.
    
    \itemparagraph{Direct Missile Hit.} If the damage roll was prompted by a Direct Missile Hit, apply a modifier of $-2$. This does not apply to Proximity Missile Hits.
    
    \itemparagraph{Rocket Attack.} If the damage roll is the result of a rocket attack, apply a modifier of $-2$ just as for Direct Missile Hits.
