...
\item
The vertical range is the difference in altitude levels divided by two and rounded down. That is, each two full altitudes levels of difference counts as one hex of vertical range.
\item
...
\begin{itemize}
    \itemaddedin{2Z}{2Z-editing}{If an aircraft carries out a head-on gun attack at range 0 (see rule~\ref{rule:air-to-air-gun-combat}) on a target at the same altitude.}
    \item \x{
