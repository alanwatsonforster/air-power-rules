...
\begin{itemize}
    ...
    \itemaddedin{1B}{1B:apj-36-errata}{An aircraft that have already rolled for a collision for a head-on gun attack does not roll again for a collision again at the end of the flight phase.}
\end{itemize}
