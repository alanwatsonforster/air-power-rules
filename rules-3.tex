...
\begin{itemize}
    ...
    \caption{\protect\x{Map Location.}{Counters representing aircraft and missiles may be located wholly within a hex or on a hexside. When located within a hex, the game counter must face towards one of the sides or one of the corners. When located on a hexside, the game counter must face along the hexside.}}
...
Collisions are possible during the Flight Phase whenever an aircraft executes a head-on gun attack at range zero\addedin{1C}{FH in APJ 36 errata}{ and the aircraft are at the same altitude}. Collisions are also possible at the end of \changedin{1C}{FH in APJ 36 errata}{a game-turn}{the flight phase} in the following situations:
...
\paragraph{Collision Exceptions:} There are \changedin{1C}{FH in APJ 36 errata}{two}{three} exceptions to the Potential Collision rule.
...
\begin{itemize}
    ...
    \itemaddedin{1C}{FH in APJ 36 errata}{An aircraft that have already rolled for a collision for a head-on gun attack does not roll again for a collision again at the end of the flight phase.}
\end{itemize}
