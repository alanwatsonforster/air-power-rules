...
Altitude levels are grouped into altitude bands, each several levels thick. Aircraft and missile performance can vary between the altitude bands. The altitude structure is shown in  Table~\ref{table:altitude-bands}.
...
Other than in the exceptional cases noted below, the range in hexes between two counters is determined as follows.
