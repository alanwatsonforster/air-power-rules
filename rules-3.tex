...
\begin{itemize}
\item
The horizontal range is the length of the shortest route between the map locations, measured in hexes. Moving between a hex side and one of the two adjacent hexes or four adjacent hex sides counts as one-half of a hex, as shown in Figure~\ref{figure:range}. After determining the number of hexes, including half hexes, round down. That is, half hexes can only contribute a full hex to the horizontal range if both the initial and final segments of the route are half hexes.
\item
