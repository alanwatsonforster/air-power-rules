...
\paragraph{Snap Turn Drag} Any time a Snap Tirn is used in a game turn, the aircraft incrues decel points as it if did a BT turn unless the aircrafts highest allowed turn rate was HT, in which case HT decel + 2.0 is incurred. If an aircraft later turns at the ET turn rate within the game turn, the ET decel would be used instead.
