...
\IfStrEq{\thisversion}{1C}{
    % With additional changes from authoritative sources, including statements by JDW or FH’s article in APJ 36.
...
\IfStrEq{\thisversion}{2B}{
    ...
    \newcommand{\earlierversions}{1A1B1C12A}
}{}
\IfStrEq{\thisversion}{2Z}{
    \newcommand{\earlierversion}{2B}
    \newcommand{\earlierversions}{1A1B1C12A2B}
}{}
