...
\Ax{
\paragraph{Missile Launch Restrictions.} 
The following restrictions apply to all types of missile:
\begin{itemize}
...
The following restrictions apply to IR missiles:
...
The following restrictions apply to BR, RH, and AH missiles:
...
Announce the type and number of missiles each aircraft will attempt to fire (one or two) and their intended target during the air-to-air missile launch phase.
