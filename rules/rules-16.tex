...
\paragraph{Auto-Track Radar Search Procedure.} Normal radar search is not allowed in the air-radar search and lock-on phase. Instead, the radar's arc is considered to be the \emph{\arcrange{180}{+}} arc and its maximum range is the \emph{search} strength in hexes. Then, one of two procedures may be chosen:
\begin{enumerate}
