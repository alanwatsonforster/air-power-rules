...
The target of an air-to-air search or tracking attempt, in any radar mode, must satisfy these common requirements:
...
\begin{itemize}
        ...
        \item It does not prepare for or execute any special maneuvers except slides and vertical rolls. It may execute at most one vertical roll per game turn.
