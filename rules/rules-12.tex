...
\begin{itemize}
   ...
   \item\itemparagraph{First Kill.} The side which achieves the first aircraft kill in the scenario receives a modifier of $+1$.
    ...
    \item\itemparagraph{Crew Quality.} If advanced rule~\ref{rule:crew-quality} on crew quality is being used, the quality, attributes, and characteristics of the pilot modify the initiative according to Table~\ref{table:initiative-modifiers}.

	\item\itemparagraph{Formations.} If advanced rule~\ref{rule:formations} on formations is being used, a winger in a tactical formation with an initiative that is less than that of the formation’s leader may add one to its initiative (reflecting teamwork and radio calls) and an aircraft not in a close or tactical formation subtracts one from its initiative unless at least one of its crewmembers is a veteran.
...
\begin{itemize}
    ...
    The aircraft is sighted and does not hold a position of advantage over any enemy aircraft, and at least one enemy aircraft holds a position of advantage over it.
    
    \item\itemparagraph{Nonadvantaged.} This category includes two types of aircraft. 
    \begin{itemize}
        \item The aircraft is sighted and does not hold a position of advantage over any enemy aircraft, and no enemy aircraft holds a position of advantage over it.
        \item The aircraft is sighted and holds a position of advantage over at least one enemy aircraft, and at least one enemy aircraft holds a position of advantage over it.
    \end{itemize}

    \item\itemparagraph{Advantaged.} 
    The aircraft is sighted and holds a position of advantage over at least one enemy aircraft, and no enemy aircraft holds a position of advantage over it.

    \item\itemparagraph{Unsighted.} The aircraft is not sighted by any enemy aircraft.

    \item\itemparagraph{Undetected.} The aircraft is neither detected by radar nor sighted.
...
\paragraph{Position of Advantage.} An aircraft has a position of advantage over an enemy aircraft if:
\begin{itemize}
    \item It is free.
    ...
    \item If the enemy aircraft is higher, the aircraft must not be in a vertical dive.
\end{itemize}

Additionally, an aircraft in a vertical dive may not hold a position of advantage over a higher aircraft but may hold a position of advantage over an aircraft at the same or lower altitude. An aircraft in a vertical climb may hold a position of advantage over an aircraft at lower, the same, or higher altitude.

A tailing aircraft (see rule~\ref{rule:tailing-enemy-aircraft}) is considered to hold a position of advantage over the aircraft it is tailing but cannot hold a position of advantage over other aircraft. Other aircraft may consider or not the tailing aircraft, as they so desire.
...
\begin{itemize}
    ...
    \item Its start speed \addedin{1B}{1B-tailing}{for the next game turn }is not more than 1.0 greater than the enemy's.
...
\item It has one or more friendly aircraft that have not yet moved in its \arcrange{150}{+} arc and within six hexes of range and
\item It has not declared a defensive preemption in the current game turn.
\end{itemize}
The friendly aircraft involved are threatened.

\paragraph{Preemption Requirements} A threatened aircraft may preempt the normal order of flight once per game turn provided one of the following conditions is satisfied:
\begin{itemize}
     \item At the start of the threatening aircraft’s move, it is individually sighted by the threatened aircraft,
     \item At the start of the threatening aircraft’s move, it and the threatened aircraft are individually sighted by an aircraft friendly to the threatened aircraft, or
...
\paragraph{Preemption Restrictions.} An aircraft that does a defensive preemption is restricted for the remainder of the current game turn as follows:
