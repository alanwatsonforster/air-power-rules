...
Applying them, we see that the target is within the combined arc of the radar if it has an altitude of 5 to 15 inclusive and is within the \arcrange{180}{+} horizontal arc.
