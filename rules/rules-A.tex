...
The ranges determined using this procedure are symmetric, in the sense that the range from a first element to a second is the same as the range from the second element to the first.
...
\item
When attempting to sight a higher aircraft or missile in daylight, the vertical range is the difference in altitude levels divided by \emph{four} and rounded down (see rule~\ref{rule:sighting-aircraft-and-missiles}).
