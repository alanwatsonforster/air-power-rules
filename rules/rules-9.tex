...
\begin{itemize}
    ...
    When determining the horizontal arc, the target is the reference aircraft and the attacker is the distant aircraft. Resolve borderline cases by first moving the faster aircraft forward. If the faster aircraft remains on the borderline, choose the narrower arc.
    }
