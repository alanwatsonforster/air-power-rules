...
For example, consider Figure~\ref{figure:angle-off}, in which the aircraft A1/A2/A3 are targets and the aircraft B1/B2/B3 and C1/C2/C3 are attackers. Aircraft C2 is unambiguously on the \arc{0} line, and C1 is unambiguously in the right \arc{90} arc, but the other attackers are on borderlines between two arcs. Aircraft C3 cannot be on the \arc{0} line as it is not facing the target.
