...
\tablecaption{table:missile-speed-math-saver}{\x{Missile Speed Math-Saver}{Missile Average Speeds}}

\begin{tabular}{crrrr}
\toprule
\multirow{2}{*}[-0.5ex]{\minitable{c}{\x{Miss.}{Start}\\Speed}}&\multicolumn{4}{c}{Attenuation Factor}\\
\cmidrule{2-5}
&0.9&0.8&0.7&0.6\\
\midrule
\phantom{0}2& 2& 2& 1& 1\\
