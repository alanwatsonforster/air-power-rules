...
Sustained turning&1.0 additional DP for each 30{\deg} of facing change after the first facing change (0.5 DPs if LBR and 1.5 DPs if HBR).&\mbox{\ref{rule:sustained-turning}$^*$}\\
Turning at supersonic speeds&1.0 additional DP for the game turn (0.0 DPs if GSSM and 2.0 DPs if PSSM).&\mbox{\ref{rule:supersonic-speed-effects}$^*$}\\
\addlinespace
