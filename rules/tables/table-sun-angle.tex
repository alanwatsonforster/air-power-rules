...
\toprule
Die Roll   &Time of Day        &Direction&Angle \\
\midrule
1          &Dawn	           &East&0 levels per hex. \\
2 to 3     &Early Morning      &East&1 level per two hexes. \\
4	       &Late Morning	   &East&1 level per hex. \\
5 to 6     &Noon	           &Overhead&Any level below and within two hexes. \\
7	       &Early Afternoon    &West&1 level per hex. \\
8 to 9     &Late Afternoon     &West&1 level per two hexes. \\
10	       &Dusk	           &West&0 levels per hex. \\
\bottomrule
\end{tabularx}
\end{twocolumntable}
\end{twocolumntablefloat}
