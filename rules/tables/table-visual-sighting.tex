...
\midrule
\multicolumn{4}{c}{Sighting during Day}\\
\midrule
...
\midrule
\multicolumn{4}{c}{Sighting \wbox[l]{during Day}{at Night}}\\
\midrule
...
\midrule
\multicolumn{4}{c}{Identification during Day}\\
\midrule
...
\midrule
\multicolumn{4}{c}{Identification \wbox[l]{during Day}{at Night}}\\
\midrule
...
%\begin{itemize}
$^*$ Advanced rule. $^a$ Identification at night requires the same position, facing, and speed as the target.
%\end{itemize}
\end{tablenote}
}{
...
\begin{itemize}
   \item $^*$ Advanced rule.
   \item If the searcher, target, or both are in haze (see advanced rule \ref{rule:haze}), consider the sighting range to be twice the normal range.
\end{itemize}
\end{tablenote}
}
\end{twocolumntable}
