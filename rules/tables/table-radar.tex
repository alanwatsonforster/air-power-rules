...
\phantom{0}2&$\le\phantom{0}1$&&$\le\phantom{0}1$&Any\\
\phantom{0}3&$\le\phantom{0}2$&&$\le\phantom{0}3$&Any\\
\phantom{0}4&$\le\phantom{0}3$&&$\le\phantom{0}5$&Any\\
...
\midrule
Veteran&$-1$&Yes&No&\ref{rule:crew-quality}\advancedrulemark\\
Novice&$+1$&Yes&No&\ref{rule:crew-quality}\advancedrulemark\\
Green&$+2$&Yes&No&\ref{rule:crew-quality}\advancedrulemark\\
...
\begin{onecolumntablefloat}
\begin{onecolumntable}
\tablecaption{table:ew-radar-break-lock-rolls}{Breaking Lock-Ons with ECM}
