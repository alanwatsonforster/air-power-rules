...
\CY[3A-sighting-modifiers]{RWR indications}{Radar or RWR detection or IRSTS lock-on}&$-1$\\
\CY[3A-sighting-modifiers]{IRSTS lock-on and HUD interface}{Radar detection or IRSTS lock-on and HUD interface}&$-1$\\
\bottomrule
\end{tabularx}
