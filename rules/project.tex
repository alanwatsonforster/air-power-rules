...
\begin{itemize}
    ...
    \itemtag{3A-angle-off} The angle-off rules have been rewritten and consolidated in rule 3. The rules for disambiguating the arc for missile attacks has been changed (to consider first relative speed and then choose the wider arc). The rules for the arc at the same location has been changed (to be the same as it would be if the distant element was moved back one hex).
