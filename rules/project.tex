...
\begin{itemize}
    ...
    \itemtag{3A-searcher} The searcher is designated by the player and need not be the closest aircraft.
    
    \itemtag{3A-restricted-arc} The $+2$ modifier applies if the target is in the restricted arc of the searcher, not all participating aircraft.
    
    \itemtag{3A-uncamouflaged} The “uncamouflaged” paint scheme has been divided into “light” and “dark”. The “lower” position has been divided into “lower (land)” and “lower (sea)”.
    
    Light corresponds to, for example, USN aircraft in Vietnam, and dark corresponds to USN aircraft in Korea and RN aircraft.  
    
    The modifiers for light are the same as the original modifiers for uncamouflaged. The modifiers for lower (land) and lower (sea) are the same as the original modifiers for lower except that dark over sea is $+1$ (the same as camouflaged over land), dark over land is $+0$, and camouflaged over sea is $-1$.
    
    \itemtag{3A-sighting-detection} The version 1A rules give a $-1$ modifier for a RWR detection, but not other types of detections. In 3A this is changed to be a $-1$ modifier for any type of detection or lock-on.
    
    \itemtag{3A-sighting-hud} The version 1A rules give a $-1$ modifier for an IRSTS lock-on and HUD interface technology, but not for a radar lock-on. In 3A this is changed to be a $-1$ modifier for any type of lock-on with HUD interface technology.
