...
\begin{itemize}
    ...
    \itemtag{2B-irsts-c} IRSTS-C, from the v2.4 rules, is added.
...
\begin{itemize}
    ...
    \itemtag{3A-sighting-modifiers} A $+1$ modifier is given for a radar or RWR detection or and IRST lock-on. An additional $+1$ modifier is given for a radar detection or IRST lock-on (but not a RWR detection) and a HUD interface.
