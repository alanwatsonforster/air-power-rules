...
\begin{itemize}
    ...
    \itemaddedin{2B}{AWF}{Cruise Speed. If idle or normal power is selected, the cruise speed (rule~\ref{rule:cruise-speeds}) is modified according to the configuration at the start of a game turn.}
