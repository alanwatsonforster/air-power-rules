...
\begin{itemize}
    ...
    \item IRSTS-B (advanced) covers the \arcrange{150}{+} \CY[3A-combined-arcs]{arc}{combined arcs (see rule \ref{rule:combined-arcs})} and successfully locks-on on a roll of $8-$.
