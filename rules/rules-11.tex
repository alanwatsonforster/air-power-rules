...
\begin{itemize}
    ...
    \item attempt to sight a target already detected by radar in the searcher’s 180{\deg} angle-off arcs and within 10 times the target’s visibility number, or
...
\paragraph{VAS Considerations.}   VAS systems may be used to accomplish target identification. 
}
