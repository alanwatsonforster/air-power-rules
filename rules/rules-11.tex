...
\AY[3A-sighting-weather]{\relevantadvancedrules{\ref{rule:haze-and-cloud-layers}.}}
...
\relevantadvancedrules{\ref{rule:vas}, \ref{rule:irsts}, \ref{rule:limited-intelligence}, \ref{rule:contrail-layers}, \ref{rule:haze-and-cloud-layers}, and~\ref{rule:night-and-adverse-weather-flight}.}
...
\relevantadvancedrules{\ref{rule:hud}, \ref{rule:irsts}, \ref{rule:crew-ability-effects}, \ref{rule:dds}, \ref{rule:rwr}, and~\ref{rule:haze-and-cloud-layers}.}
...
\item\itemparagraph{Maximum Sighting Range.} The maximum sighting range at night is doubled (see advanced rule \ref{rule:night}).
