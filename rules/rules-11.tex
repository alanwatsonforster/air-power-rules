...
\relevantadvancedrules{\ref{rule:vas}, \ref{rule:irsts}, \ref{rule:limited-intelligence}, \ref{rule:contrail-layers}, \ref{rule:haze-layers}, and~\ref{rule:night-and-adverse-weather-flight}.}
