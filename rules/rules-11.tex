...
\begin{itemize}
    ...
    \item Automatically, when its range to a friendly aircraft is within 4 times its visibility number, and it is in the \arcrange{180}{+} arc of that aircraft.

    \item On a roll of $7-$, when its range to a friendly aircraft is within 10 times its visibility number and it is in the \arcrange{180}{+} arc of that aircraft.
