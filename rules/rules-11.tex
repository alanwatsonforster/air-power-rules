...
When determining the horizontal arc, the aircraft attempting sighting is the reference aircraft and the aircraft or missile being sighted is the distant aircraft. Resolve borderline cases by first moving the faster element forward. If the faster element remains on the borderline, use the rearward arc.
}
