...
\changedin{2A}{2A-roll-preparatopry-fps}{
...
A maneuver usually requires the use of preparatory FPs before the maneuver itself is executed. These FPs represent the aircraft’s movement during the maneuver. An aircraft is performing the maneuver from the first preparatory FP until the FP used for actual execution. 

Slide maneuvers normally require two preparatory HFPs, and displacement and lag roll maneuvers require preparatory FPs equal to {\onethird} of the aircraft’s speed (rounded down).  However, maneuvers performed at altitude and at high speed require additional preparatory FPs, according to Table~\ref{table:preparatory-fps}.
...
\item \itemparagraph{SL Procedure.} Declare the start of a slide and its direction. Use 2.0 or more preparatory HFPs and then 1.0 HFP to move the aircraft forward and to the left or right as declared.
