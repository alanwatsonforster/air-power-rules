...
Range is used to determine relative closeness. If two aircraft have different ranges from a reference aircraft, the one with the smaller range is considered to be closer to the reference aircraft. If two aircraft have the same range, they are considered to be equally close.
