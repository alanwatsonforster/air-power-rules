...
\paragraph{Sighting.} The following modifiers apply to sighting rolls:
\begin{itemize}
...
\end{itemize}
With the exception of the eyesight modifiers, these also apply to VAS sighting rolls (advanced rule \ref{rule:vas}).

\paragraph{Departed Flight.} Tables~\ref{table:departed-flight-avoidance} and \ref{table:departed-flight-avoidance} give modifiers for the die rolls to entering and recovering from departed flight.
