...
\section{Determining Crew Ability}

Some scenarios give crew abilities explicitly, and no further action is required.

Other scenarios do not give the crew abilities explicitly, but instead give a training standard for each side (excellent, good, average, limited, or poor). In these cases:
...
\section{Crew Member Attributes}
\label{rule:crew-attributes}
...
\section{Crew Member Characteristics}
\label{rule:crew-characteristics}
