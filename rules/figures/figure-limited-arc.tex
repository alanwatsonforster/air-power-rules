...
\begin{fitwidth}{5.2\standardhexwidth}
\begin{tikzpicture}
\begin{scope}[rotate=90]

    %\drawhexgrid{1}{0}{15}{4}
    %\drawpositiongrid{1}{0}{15}{4}
    
    \cliphexgrid{0.9}{-0.1}{15.1}{4.1}
...
\begin{scope}[rotate=90]
    ...
    %\drawpositiongrid{0}{0}{14}{4}
    \cliphexgrid{-0.1}{-0.1}{14.1}{4.1}
