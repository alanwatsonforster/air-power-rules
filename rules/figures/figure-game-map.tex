...
\figurecaption{figure:game-map}{\protect\x{Game Maps}{The game maps are printed with a hex grid to clearly define the positions of the game counter and determine the horizontal distances between them. The two aircraft game counters are six hexes apart horizontally. The larger megahexes are five hexes across and can be used to count long distances in fives.
}}
