...
\figurecaption{figure:displacement-roll-maneuvers}{Displacement rolls to the right, each with two preparatory HFPs. The number of preparatory FPs required depends on the aircraft speed and other factors. The execution of a displacement roll is identical to that of a slide, although other aspects are different.}
