...
\begin{fitwidth}{3.333\standardhexwidth}
\begin{tikzpicture}
...
\figurecaption{figure:range}{Range. The map locations shown in gray are half a hex from the map location shown in black.}
