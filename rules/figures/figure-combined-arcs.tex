...
\newenvironment{combinedarcfigure}{
    ...
    \begin{scope}[scale=0.4]
        ...
        \begin{scope}[shift={(\xmax-8.5,0)}]
            ...
            \draw [very thick,color=Tpurple](0,+4) -- (1,+4) node [color=black,anchor=west] {$\mbox{FS} = +\infty$};
            \draw [very thick,color=Tred   ](0,+3) -- (1,+3) node [color=black,anchor=west] {$+3 < \mbox{FS} < +\infty$};
            \draw [very thick,color=Tgreen ](0,+2) -- (1,+2) node [color=black,anchor=west] {$+1 < \mbox{FS} \le +3$};
            \draw [very thick,color=Torange](0,+1) -- (1,+1) node [color=black,anchor=west] {$0 < \mbox{FS} \le +1$};
            \draw [very thick,color=Tblue  ](0,+0) -- (1,+0) node [color=black,anchor=west] {$\mbox{FS} = 0$};
            \draw [very thick,color=Tbrown ](0,-1) -- (1,-1) node [color=black,anchor=west] {$0 > \mbox{FS} \ge -1$};
            \draw [very thick,color=Tpink  ](0,-2) -- (1,-2) node [color=black,anchor=west] {$-1 > \mbox{FS} \ge -3$};
            \draw [very thick,color=Tolive ](0,-3) -- (1,-3) node [color=black,anchor=west] {$-3 > \mbox{FS} > -\infty$};
            \draw [very thick,color=Tcyan  ](0,-4) -- (1,-4) node [color=black,anchor=west] {$\mbox{FS} = -\infty$};
        \end{scope}
    \end{scope}
}
