...
\section{Types of Primary Flight}
...
At the start of an aircraft's move, it must select one of the following three primary types of flight: level, climbing, or diving. These represent the aircraft committing its nose to remain level, to move up, or to move down for the game turn. Write the appropriate code in the primary flight type line of the aircraft log. Once selected, aircraft may not change its primary flight type until the next game turn. Aircraft may perform only one type of primary flight each game turn.
}
...
\relevantadvancedrules{\ref{rule:changing-primary-flight-type}.}
...
Two other primary types of flight are possible. These are stalled flight and departed flight (see rule~\ref{rule:abnormal-flight}
...
\label{rule:changing-primary-flight-type}
