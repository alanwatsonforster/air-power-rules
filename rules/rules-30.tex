...
\paragraph{Climate Types.} The climate types are polar, temperate, arid, and tropical.
...
\item 
IRMs and IR SAMs launched at the target will have a $+3$ modifier to their launch roll.
\item
...
\item
AAA units firing on the target with aimed fire suffer a $+1$ modifier to their hit die roll.
\end{itemize}
