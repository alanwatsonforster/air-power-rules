...
Haze layers can be one or more altitude bands thick. They partially block visible light and reduce contrast. The effects of haze layers are:
\begin{itemize}
...
\item\itemparagraph{Adverse Conditions.} At night, an aircraft below a stratus cloud layer is considered to be flying in adverse conditions (see rule \ref{rule:adverse-conditions}).
...
\item\itemparagraph{Visual Sighting Modifiers.} Dense cloud layers give the following sighting modifiers:
\begin{itemize}
...
\item\itemparagraph{Adverse Conditions.} At night, an aircraft below a dense cloud layer is considered to be flying in adverse conditions (see rule \ref{rule:adverse-conditions}).
