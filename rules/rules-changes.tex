...
\newcommand{\x}[3][2C-editing]{\changedin{2C}{#1}{#2}{#3}}
...
\newcommand{\Y}[3][3A-editing]{\changedin{3A}{#1}{#2}{#3}}
\newcommand{\AY}[2][3A-editing]{\addedin{3A}{#1}{#2}}
\newcommand{\DY}[2][3A-editing]{\deletedin{3A}{#1}{#2}}
\newcommand{\SAY}[2][3A-editing]{\silentlyaddedin{3A}{#1}{#2}}
\newcommand{\IAY}[2][3A-editing]{\itemaddedin{3A}{#1}{#2}}
