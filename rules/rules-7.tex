...
\end{itemize}
An aircraft's ADC, configuration, speed, and altitude may restrict the available turn rates. Furthermore, if advanced rule~\ref{rule:crew-ability} is being used, green pilots may not use the ET rate.
}
...
\begin{itemize}
    ...
    \item\itemparagraph{Unconscious Pilot.} The aircraft's flight is randomized and controlled by Table~\ref{table:gloc-flight}. If the pilot is GLOCed when the aircraft still has FPs to use, roll on the table to finish the aircraft's move. Roll the die on subsequent game turns until the pilot recovers or is ejected or the aircraft is destroyed.
