...
Roll the die once for each crewmember and apply any required modifiers\addedin{1C}{1C-tables}{\ from Table~\ref{table:gloc-avoidance}}. A result of $1-$ results in GLOC. 
}
...
\paragraph{GLOC Duration and Recovery.} \CX{
