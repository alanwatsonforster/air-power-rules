...
GLOC can occur when an aircraft changes facing at the ET rate in the LO, ML, or MH altitude bands. Each crew member must check for GLOC after each facing change at the ET rate in these bands. At higher altitudes, the G-force of an ET turn is insufficient to cause GLOC.
}
