...
\AY{
\paragraph{Supersonic Acceleration.}

A supersonic aircraft (see rule \ref{rule:supersonic-speed-effects}) requires 3.0 APs (instead of 2.0 APs) to increase speed by 0.5. It decelerates normally.

For example, a supersonic aircraft has accumulated 6.0 APs and 2.0 DPs, and so has a net of 4.0 APs. Its speed is increased by 0.5, and 1.0 AP is carried forward to the next game turn.
...
\paragraph{Rapid Acceleration Aircraft.} If an ADC notes that an aircraft has rapid acceleration (RA), it is an exceptionally clean design that speeds up quicker than normal. A subsonic RA aircraft requires only 1.5 APs (instead of the normal 2.0 APs) to increase speed by 0.5 FP and a supersonic RA aircraft requires only 2.0 APs (instead of the normal 3.0 APs) to increase speed by 0.5 FP. In both cases, it decelerates normally.

For example, a subsonic RA aircraft has accumulated 6.0 APs and 2.0 DPs, and so has a net of 4.0 APs. Its speed is increased by 1.0, and 1.0 AP is carried forward to the next game turn.
}
\DX{
...
If an ADC notes that an aircraft has rapid power response (RPR), it may safely increase power by any amount each turn. 

Aircraft may decrease their power setting without limit or risk. 
...
The ADC of a propellor aircraft may note that it has have its power reduced at high speed or altitude. Such reductions apply to both the half-throttle and full-throttle settings.
}
