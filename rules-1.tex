...
\begin{itemize}
    ...
    \item Each altitude band 
          \addedin{1B}{TSOH Errata}{typically}
...
\addedin{1B}{TSOH Errata}{The two aircraft counters were left off the diagram.}
...
\addedin{1B}{TSOH Errata}{Altitude differences may affect range calculations.}
