...
For example, \changedin{1C}{AWF}{as}{Figure~\ref{figure:game-map} shows two game counters on a game map. As} each hex represents {\onethird} of a mile of distance, and as the two aircraft counters shown\deletedin{1C}{AWF}{ in the diagram below} are 6 hexes apart, they are a scale two miles apart. 
\deletedin{1C}{AWF}{\addedin{1B}{JDW in the APJ 23 errata}{[The two aircraft counters were left off the diagram.]}}
