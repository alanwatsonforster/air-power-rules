...
\begin{itemize}
    ...
    \item\itemparagraph{Advantaged.} An aircraft which has a spotted enemy aircraft in its 150° or 180° angle off arc within 9 hexes and not more than 6 altitude levels above or 9 altitude levels below it. \addedin{1B}{FH in APJ 36 errata}{An aircraft may be more than 9 hexes range away from an aircraft it is advantaged over, the 9 hex limit applies only to horizontal range.}
...
\addedin{1B}{JDW in the APJ 23 errata}{Aircraft in vertical climbs or vertical dives may not disadvantage aircraft that are lower or higher than them, respectively. Aircraft in the same hex, regardless of relative altitudes, have no effect on each other advantage-wise unless one is tailing another.}
...
\begin{itemize}
    ...
    \item The tailing aircraft's start speed \addedin{1B}{JDW in message to airpower group on 2024-02-02}{for the next game turn }is not more than 1.0 greater than the tailee's.
