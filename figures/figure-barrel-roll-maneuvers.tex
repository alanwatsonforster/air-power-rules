...
\end{tikzfigure}
\caption{A barrel roll executed as a sequence of two lag rolls to the right followed by one displacement roll to the right, each with two preparatory HFPs. Any combination of lag rolls and displacement rolls may make up a barrel roll, but all must be in the same direction. The number of preparatory HFPs required before each roll depends on the aircraft speed and other factors.}
}
\label{figure:barrel-roll-maneuvers}
\end{figure}
