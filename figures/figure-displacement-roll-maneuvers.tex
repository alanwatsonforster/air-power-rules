...
\end{tikzfigure}
\CAPTION{figure:displacement-roll-maneuvers}{Displacement Roll Maneuvers}
}{
\begin{tikzfigure}{11.333\standardhexwidth}
\scriptsize
...
\end{tikzfigure}
\CAPTION{figure:displacement-roll-maneuvers}{Displacement rolls to the right, each with two preparatory HFPs. The number of preparatory HFPs required depends on the aircraft speed and other factors.}
}
\end{FIGURE}
