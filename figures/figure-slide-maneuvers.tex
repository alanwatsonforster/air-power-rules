...
\end{tikzfigure}
\x{
\caption{Slide Maneuvers}
}{
\caption{Slides to the right, each with two preparatory HFPs. The number of preparatory HFPs required depends on the aircraft speed and other factors.}
}
\label{figure:slide-maneuvers}
\end{figure}
