...
\end{tikzfigure}
\caption{Lag Roll Maneuvers}
}{
\begin{tikzfigure}{1.0\linewidth}
\scriptsize

    \drawhexgrid{1}{0}{11}{5}
...
\end{tikzfigure}
\caption{Lag rolls to the right, each with two preparatory HFPs. The number of preparatory HFPs required depends on the aircraft speed and other factors.}
}
\label{figure:lag-roll-maneuvers}
\end{figure}
