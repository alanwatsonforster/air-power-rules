...
\begin{itemize}
    ...
    \item In combat: Gun attacks, visual bombing or rocket attacks, and IRM launches.
\end{itemize}
...
A Green pilot receives a minus 2 die roll modifier when checking for GLOC.
...
\subsection{Crew Quality and Damage Control.} Green pilots may not normally do damage control. Novice pilots must spend two consecutive game turns applying damage control to stop progressive damage.
...
\begin{itemize}
    ...
    \item Confidence affects initiative, departure recovery, and disorientation die rolls.
\end{itemize}
...
The maximum is excellent confidence and the minimum is poor confidence.
