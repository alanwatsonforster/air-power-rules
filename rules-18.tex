...
\begin{itemize}
    ...
    \item In combat: Gun attacks, visual bombing or rocket attacks, \changedin{1B}{JDW in APJ 22 QA and APJ 39 QA}{and IRM launches}{IRM launches, and the use of auto-track and boresight radar modes}.
\end{itemize}
...
A Green \changedin{1B}{JDW in APJ 34 QA}{pilot}{crewmember} receives a minus 2 die roll modifier when checking for GLOC.
...
\paragraph{Crew Quality and Damage Control.} Green pilots may not normally do damage control. Novice pilots must spend two consecutive game turns applying damage control to stop progressive damage\addedin{1B}{JDW in APJ 39 QA}{, and so there is a risk of progressive damage on the first of these two turns}.
...
\begin{itemize}
    ...
    \item Confidence affects initiative, departure \changedin{1B}{JDW in APJ 39 QA}{recovery}{entry}, and disorientation die rolls.
\end{itemize}
...
\changedin{1B}{FH in APJ 36 errata}{The maximum is excellent confidence and the minimum is poor confidence.}{Confidence cannot be improved above excellent or below poor. “Excess” changes after each mission are lost.}
