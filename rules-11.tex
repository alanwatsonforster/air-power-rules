...
This chapter details the procedures for visual detection and tracking of targets. \addedin{1D}{1D-tables}{The rules are summarized in Table~\ref{table:sighting-rules-summary}}
...
\paragraph{Modifiers.} The die roll for sighting may be modified by a variety of circumstances. The modifiers available are shown on the \changedin{1D}{1D-tables}{Sighting Charts}{Tables~\ref{table:sighting-range-modifiers}, \ref{table:sighting-position-modifiers}, and \ref{table:sighting-additional-modifiers}} and include:
