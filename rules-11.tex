...
Each Ground FAC may mark one enemy unit (which it can see) during the \changedin{2B}{2B-consistency}{AAA Planning Phase}{visual sighting phase} of each turn. If the Ground FAC marks the target with a laser spot, the marking is removed at the end of the game turn. If the Ground FAC marks the target with smoke, the marking is removed at the end of the next game-turn (the marking lasts two turns).
