...
An exception to this is that an aircraft noted in the ADC as having a high pitch rate must only expend HFPs equal to 1/3 of its speed (round down) before using VFPs.
}
