...
Example Of Level Flight: An aircraft has a speed of 3.0. The player moves the aircraft through three hexes as shown below. \addedin{1B}{JDW: TSOH errata}{(The diagram actually shows the left aircraft moving 3 hexes/hexsides. This is in error.)} Its turn is over when it has finished moving.
...
For example, an aircraft with a start speed of 6.5 having a carried 0.5 FP in the Carry line of the Aircraft Log has 7.0 FPs to expand that game turn. For all applicable game purposes, its speed is still 6.5. If a 0.5 FP carry cannot be mated to a half FP in the start speed, it may be carried forward again (and again) until used. When used, it is gone.
