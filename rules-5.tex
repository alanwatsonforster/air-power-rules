...
Example Of Level Flight: An aircraft has a speed of 3.0. The player moves the aircraft through three hexes as shown \changedin{1C}{AWF}{below}{in Figure~\ref{figure:level-flight}.}\deletedin{1C}{AWF}{\addedin{1B}{JDW in the APJ 23 errata}{ [The diagram actually shows the left aircraft moving four hexes/hexsides. This is in error.]}} Its turn is over when it has finished moving.
