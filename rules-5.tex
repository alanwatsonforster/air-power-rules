...
\addedin{1B}{1B-apj-36-errata}{When an expenditure of $2/3$ of an aircraft's speed (or FPs) is required, use the $2/3$ entry from \changedin{1D}{1D-tables}{the chart}{Table~\ref{table:fractions}}, not $2 \times 1/3$. Drop all fractions read off the chart, unless the entry is 0.5, in which case read 1. In this case 1 FP qualifies as 2/3.}
