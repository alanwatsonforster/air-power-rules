...
\paragraph{External DDS.} External DDS pods are identified \changedin{1D}{1D-tables}{on the External Pod Table}{Table~\ref{table:ew-pods}}, which shows the possible loads of decoys available.
