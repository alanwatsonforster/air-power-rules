...
\addedin{1C}{JDW in APJ 34}{IFF status is declared during the aircraft decisions phase.}
...
\addedin{1C}{JDW in APJ 27}{Unless otherwise stated in the ADC, aircraft with internal BJMs and dedicated crew to run them (electronic warfare officers) have no frequency limits.}
...
\addedin{1C}{JDW in APJ 39}{BJMs do not break locks once achieved.

All internal BJMs may affect both air search and lock-on die roll attempts.}
...
\addedin{1C}{JDW in APJ 39}{All type A and B internal AJMs affect only air radar lock on attempt rolls. All type C and D internal AJMs affect both search and lock-on attempt rolls.}
...
\addedin{1C}{JDW in APJ 39}{All internal DJM types may attempt to break any air radar lock-ons.}
