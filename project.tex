...
\begin{itemize}
    ...
    \item An aircraft that selects idle power no longer has its start speed reduced. Instead, the aircraft incurs DPs for normal power plus the additional DPs listed in the ADC. (See the Origins rules {\APJ}~39, 41, 44, and 53 and the v2.4 rules. These changes are tagged in the rules as “2A:idle”.) 

    \item Similarly, an aircraft that uses speedbrakes no longer loses FPs. Instead, the aircraft incurs DPs up to the value shown in the ADC. If the aircraft is supersonic, the maximum is increased by 1 DP. (See the Origins rules {\APJ}~39, 41, 44, and 53 and the v2.4 rules. These changes are tagged in the rules as “2A:spbr”.) 
    ...
    \item The cruise speed in the ADC is for CL configuration, and is 0.5 less for 1/2 configuration and 1.0 less for DT configuration. (This change was originally suggested by Guy Acala in {\APJ}~24. See the Origins rules {\APJ}~44 and 53 and the v2.4 rules. These changes are tagged in the rules as “2A:cruise”.) 
    ...
    \item The decelaration for zoom climbs (and sustained climbs that gain more than the CC) is now always 1.0 DP per level. (See the Origins rules {\APJ}~44 and 53 and the v2.4 rules. These changes are tagged in the rules as “2A:zoom-climbs”.) 
