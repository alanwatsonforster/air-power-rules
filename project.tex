...
\begin{itemize}
    ...
    \item The sighting rules are changed so that attempts to sight missiles come before attempts to sight aircraft and the modifiers are changed. (See \APJ}~44 and 53. These changes are tagged in the source as “2A:missile-sighting”.) 
    
    The Origins rules mention that missiles launched from sighted aircraft are no longer sighted, but I can't find this stated anywhere in the original rules.
