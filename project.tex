...
\begin{itemize}
    ...
    \item Lag and displacement rolls now require preparatory HFPs equal to {\onethird} of the aircraft's speed (rounded down). See the 1995 GEnie post by JD Webster and the v2.4 rules. These changes are tagged in the source as “2A:roll-preparatory-fps”.)
