...
\newcommand{\drawaircraftcounter}[5]{
    \begin{athex}{#1}{#2}
        \begin{scope}[rotate=#3-45]
            \draw[fill=white] (-0.35,-0.35) rectangle (0.35,0.35);
            \node [anchor=center,rotate=#3] {
                \includegraphics[angle=0,width=0.7cm]{plan-views/#4.png}
            };
            \node [anchor=south east,rotate=#3-45] at (+0.4,-0.4) {\textsf{\tiny #5}};
        \end{scope}
    \end{athex}
}
