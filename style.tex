...
% Align floats on their own page or column to the top.
\makeatletter
\setlength{\@fptop}{0pt}
...
\newcommand{\AIDSONLYTABLECAPTION}[2]{
    \par
    \caption{#2}
    \label{#1}
    \medskip
}
\newcommand{\CONTINUEDTABLECAPTION}[2]{
    \par
