\section{Ground Terrain and Terrain Following Flight}
...
\paragraph{Terrain Effects\protect\deletedin{1D}{1D-tables}{ Chart}.} \changedin{1D}{1D-tables}{The Terrain Effects Chart}{Table~\ref{table:terrain-effects}} details the specific types of terrain and their effects on units on the ground. Terrain may affect the degree of camouflage of units, and may affect defensive abilities.
